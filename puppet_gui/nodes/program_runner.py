...
class Runner:
    ...
    def _check_ps3_buttons(self):
        ...
        if Ps3Subscriber.select_button in triggered_buttons:
            ...
            self._soundhandle.playWave('/u/applications/ros/pr2_hack_the_future/puppet_gui/sounds/sound1.wav')
        elif Ps3Subscriber.right_button in triggered_buttons:
            self._soundhandle.playWave('/u/applications/ros/pr2_hack_the_future/puppet_gui/sounds/four_beeps.wav')
        elif Ps3Subscriber.bottom_button in triggered_buttons:
            self._soundhandle.playWave('/u/applications/ros/pr2_hack_the_future/puppet_gui/sounds/sound3.wav')
        elif Ps3Subscriber.left_button in triggered_buttons:
            self._soundhandle.playWave('/u/applications/ros/pr2_hack_the_future/puppet_gui/sounds/thankyou.wav')
